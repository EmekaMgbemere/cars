...
<div>
    <nav class="navbar bg-body-tertiary fixed-top">
      ...
      <div className='navbelow '>
        ...
        <Link to='/fashion'>Fashion and Apparel</Link>
        <Link to='/trending'>Home and Kitchen Appliances</Link>
        <Link to='/trending'>Health and Wellness</Link>
        <Link to='/trending'>Toys and Games</Link>
        <Link to='/trending'>Beauty and Personal Care</Link>
      </div>
    </nav>
</div>
            </nav>
